...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    KC_LEFT_CTRL,   KC_LEFT_CTRL,   KC_LEFT_GUI,    KC_LEFT_ALT,    LT(6,KC_ENTER), OSL(8),                                                                                                         KC_DELETE,      ST_MACRO_4,     TG(6),          KC_TRANSPARENT, LGUI(LSFT(KC_S)),TO(1),          
    LT(2,KC_BSPC),  CW_TOGG,        KC_LEFT_GUI,                    ST_MACRO_5,     TD(DANCE_2),    LT(3,KC_SPACE)
  ),
  [1] = LAYOUT_moonlander(
  ...
  [2] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_CIRC,        KC_AMPR,        KC_LABK,        KC_RABK,        KC_ASTR,                                        KC_PLUS,        KC_LBRC,        KC_RBRC,        KC_TRANSPARENT, ST_MACRO_6,     KC_TRANSPARENT, 
  ...
  [3] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, ST_MACRO_7,     ST_MACRO_8,     KC_PC_COPY,     KC_PC_PASTE,    KC_PC_CUT,                                      KC_TRANSPARENT, KC_HOME,        KC_TRANSPARENT, KC_END,         KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [4] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, ST_MACRO_9,     ST_MACRO_10,    KC_MAC_COPY,    KC_MAC_PASTE,   KC_MAC_CUT,                                     KC_TRANSPARENT, LGUI(KC_LEFT),  KC_TRANSPARENT, LGUI(KC_RIGHT), KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
  switch (keycode) {
    ...
    case ST_MACRO_4:
    if (record->event.pressed) {
      SEND_STRING(SS_TAP(X_BSLS) SS_DELAY(100) SS_TAP(X_H));
    }
    break;
    case ST_MACRO_5:
    if (record->event.pressed) {
