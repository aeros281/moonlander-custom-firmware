...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [7] = LAYOUT_moonlander(
    ...
    KC_BSPC,        KC_F10,         KC_F11,         TT(10),         KC_SPACE,       KC_LEFT_ALT,                                                                                                    TO(0),          KC_ENTER,       KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [9] = LAYOUT_moonlander(
    ...
    KC_F12,         KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_CAPS,                                                                                                        KC_TRANSPARENT, KC_ENTER,       KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [11] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, LGUI(LCTL(KC_V)),ST_MACRO_10,                                    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
...
tap_dance_action_t tap_dance_actions[] = {
        [DANCE_0] = ACTION_TAP_DANCE_TAP_HOLD(LALT(KC_TAB), KC_LEFT_SHIFT),
        [DANCE_1] = ACTION_TAP_DANCE_TAP_HOLD(LALT(KC_GRAVE), KC_LEFT_SHIFT),
        [DANCE_3] = ACTION_TAP_DANCE_TAP_HOLD(LGUI(KC_TAB), KC_LEFT_SHIFT),
        [DANCE_4] = ACTION_TAP_DANCE_TAP_HOLD(LGUI(KC_GRAVE), KC_LEFT_SHIFT),
